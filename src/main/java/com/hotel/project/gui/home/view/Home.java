...
//	}
	...
	private void preparePanel() {
		...
		btnDatPhong.setBounds(0, 196, 358, 56);
		...
		btnThanhToan.setBounds(0, 253, 358, 56);
		...
		btnDichVu.setBounds(0, 310, 358, 56);
		...
		btnKhachHang.setBounds(0, 367, 358, 56);
		...
		btnphong.setBounds(0, 424, 358, 56);
		...
		btnNhanVien.setBounds(0, 481, 358, 56);
		...
		btnThongKe.setBounds(0, 538, 358, 56);
		...
		btnDamgXuat.setBounds(0, 709, 358, 56);
		...
		btnHelp.setBounds(0, 595, 358, 56);
		panel.add(btnHelp);
		...
		btnAbout.setBounds(0, 652, 358, 56);
		panel.add(btnAbout);
