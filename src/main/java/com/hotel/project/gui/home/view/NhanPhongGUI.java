...
public class NhanPhongGUI extends JFrame {
	...
	public void preparePane() {
		...
		pnTieuDe.setBounds(0, 13, 1525, 71);
		...
		pnTTNDD.setBounds(10, 97, 521, 266);
		...
		pnTTP.setBounds(543, 97, 970, 266);
		...
		pnTTKHO.setBounds(9, 376, 521, 298);
		...
		btnNhanPhong.setBounds(1357, 683, 150, 43);
		...
		pnTTDP.setBounds(545, 374, 966, 299);
	...
	public void nhanPhong() {
		if(txtTenKH_kho.getText().equalsIgnoreCase("")) {
			...
			if(Integer.parseInt(txtSNO.getText()) <= ppp.getSoNguoiToiDa()) {
