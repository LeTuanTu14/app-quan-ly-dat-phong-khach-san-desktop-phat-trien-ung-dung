...
public class QLDatPhongGUI extends JPanel {
	...
	public void preparePane() {
		...
		paneltieuDe.setBounds(12, 13, 1519, 79);
		add(paneltieuDe);
		...
		panelPhong.setBounds(12, 151, 1519, 831);
		add(panelPhong);
		...
		btnDatPhong.setBounds(1260, 98, 254, 40);
		add(btnDatPhong);
		...
		lblMau1.setBounds(95, 106, 91, 33);
		add(lblMau1);
		...
		lblMau2.setBounds(271, 106, 91, 33);
		add(lblMau2);
		...
		lblMau3.setBounds(447, 106, 91, 33);
		add(lblMau3);
	...
	public void hienthiPhong() {
		List<HoaDon> hd = HoaDonRepo.findAllByTrangThaiThanhToan();
