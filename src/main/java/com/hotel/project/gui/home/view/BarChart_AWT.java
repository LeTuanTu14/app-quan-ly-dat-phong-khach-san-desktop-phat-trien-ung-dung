...
public class BarChart_AWT {
	...
	public ChartPanel getChartPanel( List<HoaDon> list,int nam) {
		list.forEach(hoaDon->{
			System.out.println("Hoa don barchart :"+hoaDon);
		});
		System.out.println("nam barchart :"+nam);
		JFreeChart barChart = ChartFactory.createBarChart(
   			 "Biểu đồ danh thu từng tháng trong 1 năm",           
		         "Tháng",            
		         "Tổng tiền",         
	  ...
	  public CategoryDataset createDataset(List<HoaDon> listHoaDon,int nam) {
