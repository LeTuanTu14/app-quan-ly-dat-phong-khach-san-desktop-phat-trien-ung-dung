...
public class QLDichVuGUI extends JPanel implements ActionListener{
	...
	//	setBackground(SystemColor.menu);
		...
		scrollPane.setBounds(17, 274, 1512, 670);
		...
		panel_1.setBounds(187, 106, 536, 42);
		panel.add(panel_1);
		...
		panel_1_1.setBounds(187, 44, 536, 42);
		panel.add(panel_1_1);
		...
		panel_1_2.setBounds(814, 105, 536, 42);
		panel.add(panel_1_2);
		...
		panel_1_3.setBounds(814, 44, 536, 42);
		panel.add(panel_1_3);
		...
		btnThem.setBounds(1016, 213, 123, 42);
		panel.add(btnThem);
		
		Panel panel_1_4 = new Panel();
		panel_1_4.setBounds(109, 215, 647, 42);
		panel.add(panel_1_4);
