...
public class QLKH_GUI extends JPanel{
	...
	public void prepaPanel() {
		//setSize(1014,715);
			...
			lblDanhSchKhch.setFont(new Font("Times New Roman", Font.PLAIN, 25));
			lblDanhSchKhch.setHorizontalAlignment(SwingConstants.CENTER);
			lblDanhSchKhch.setBounds(450, 185, 1081, 39);
			...
			rdbtnTheoHTn.setBounds(928, 126, 142, 31);
			...
			btnLoad.setBounds(1466, 185, 73, 31);
			add(btnLoad);
			...
			btnTm.setBounds(1078, 126, 93, 33);
			add(btnTm);
			...
			panelTTP.setBounds(19, 229, 419, 386);
			add(panelTTP);
