...
public class QLNV extends JPanel {
	...
	public void preparePanelNV() {
		...
		rdbtnN.setBounds(272, 383, 99, 23);
		...
		cbxNgay.setBounds(153, 430, 43, 31);
		add(cbxNgay);
		...
		cbxNam.setBounds(367, 430, 62, 31);
		add(cbxNam);
		...
		scrollPane.setColumnHeaderView(lblDanhSchNhn);
		lblDanhSchNhn.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		
		JButton btnThm = new JButton("Thêm");
		btnThm.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		btnThm.setBounds(50, 789, 73, 40);
		add(btnThm);
		...
		btnXa.setBounds(135, 789, 75, 40);
		add(btnXa);
		
		JButton btnSa = new JButton("Sửa");
		btnSa.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		btnSa.setBounds(222, 789, 73, 40);
		add(btnSa);
...
//		add(lblThngTinNhn);
		...
		btnXaR.setBounds(302, 789, 101, 40);
		add(btnXaR);
		
		JLabel lblDanhSchNhn_1 = new JLabel("Danh sách nhân viên");
		lblDanhSchNhn_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblDanhSchNhn_1.setFont(new Font("Times New Roman", Font.PLAIN, 25));
		lblDanhSchNhn_1.setBounds(491, 187, 1040, 34);
		add(lblDanhSchNhn_1);
		
		txtMaNV = new JTextField();
		txtMaNV.setFont(new Font("Tahoma", Font.PLAIN, 15));
		txtMaNV.setBounds(153, 254, 277, 31);
		add(txtMaNV);
		...
		txtTenNV.setBounds(153, 318, 277, 31);
		add(txtTenNV);
		
		txtCanCuoc = new JTextField();
		txtCanCuoc.setFont(new Font("Tahoma", Font.PLAIN, 15));
		txtCanCuoc.setColumns(10);
		txtCanCuoc.setBounds(153, 493, 277, 31);
		add(txtCanCuoc);
		...
		cbxchucVu.setBounds(153, 668, 277, 33);
		add(cbxchucVu);
...
//		add(txtChucVu);
		...
		rdbtnTheoHTn.setBounds(965, 141, 142, 31);
		...
		panelTTP.setBounds(52, 226, 427, 488);
		add(panelTTP);
